...
const weatherDatabase = {
  bhopal: { temp: '34°C', humidity: '65%', condition: 'Cloudy', conditionId: 'cloudy' },
  indore: { temp: '35°C', humidity: '55%', condition: 'Sunny', conditionId: 'sunny' },
  jabalpur: { temp: '33°C', humidity: '70%', condition: 'Heavy Rain', conditionId: 'rain' }
};
...
const TRANSLATIONS = {
  en: {
    ...
    uploadMain: "Drag & drop plant image or <span class=\"highlight\">browse</span>",
    ...
    chatWelcome: "Welcome to Krishi-AI. I can assist you with MP soil preparation, soybean/wheat crop cycles, and organic pest control in Hindi, Punjabi, or English. How can I support you today?",
    settingsTitle: "API Configuration",
    settingsInstruction: "Please provide your Google Gemini API Key to enable diagnostic scanning and conversational chat services. The key is stored locally in your browser cache.",
    ...
    toastScanFailed: "Failed to analyze image. Please check your API key and connection.",
    ...
    toastSpeechInputNotSupported: "Speech recognition not supported in this browser.",
    ...
    defaultAdvisories: {
      bhopal: "Delayed monsoon advisory. Sowing of soybean and maize crops should be deferred until 50-60mm of cumulative rainfall is received to prevent germination failure.",
      indore: "Dry conditions in Malwa. Prepare land for soybean and pulse sowing. Apply organic compost and monitor soil moisture levels closely.",
      jabalpur: "Heavy pre-monsoon shower alert. Ensure proper drainage in paddy nurseries. Avoid pesticide application before dry spells return."
    }
  },
  hi: {
    appTitle: "कृषि-AI",
    ...
    uploadMain: "पत्ती की तस्वीर खींचकर यहाँ डालें या <span class=\"highlight\">फ़ाइल चुनें</span>",
    ...
    chatWelcome: "कृषि-AI में आपका स्वागत है। मैं हिंदी, पंजाबी या अंग्रेजी में मध्य प्रदेश की मिट्टी की तैयारी, सोयाबीन/गेहूं चक्र और जैविक कीट नियंत्रण में आपकी सहायता कर सकता हूँ। आज मैं आपकी क्या मदद करूँ?",
    settingsTitle: "एपीआई कॉन्फ़िगरेशन",
    settingsInstruction: "डायलॉग स्कैनिंग और चैट सेवाओं को सक्षम करने के लिए कृपया अपनी Google Gemini API कुंजी दर्ज करें। कुंजी आपके ब्राउज़र कैश में सुरक्षित रहती है।",
    ...
    toastScanFailed: "छवि का विश्लेषण करने में विफल। कृपया अपनी एपीआई कुंजी और इंटरनेट की जांच करें।",
    ...
    toastSpeechInputNotSupported: "इस ब्राउज़र में स्पीच रिकग्निशन समर्थित नहीं है।",
    ...
    defaultAdvisories: {
      bhopal: "मानसून में देरी की चेतावनी। सोयाबीन और मक्का की बुवाई तब तक टालें जब तक कि 50-60 मिमी संचयी वर्षा न हो जाए, ताकि अंकुरण विफलता से बचा जा सके।",
      indore: "मालवा में शुष्क मौसम। सोयाबीन और दालों की बुवाई के लिए भूमि तैयार करें। जैविक खाद डालें और मिट्टी की नमी पर नजर रखें।",
      jabalpur: "भारी वर्षा की चेतावनी। धान की नर्सरियों में उचित जल निकासी सुनिश्चित करें। सूखे दौर की वापसी से पहले कीटनाशकों के छिड़काव से बचें।"
    }
  },
  pa: {
    appTitle: "ਕ੍ਰਿਸ਼ੀ-AI",
    ...
    uploadMain: "ਫ਼ਸਲ ਦੀ ਫੋਟੋ ਇੱਥੇ ਖਿੱਚੋ ਜਾਂ <span class=\"highlight\">ਲੱਭੋ</span>",
    ...
    chatWelcome: "ਕ੍ਰਿਸ਼ੀ-AI ਵਿੱਚ ਤੁਹਾਡਾ ਸੁਆਗਤ ਹੈ। ਮੈਂ ਪੰਜਾਬੀ, ਹਿੰਦੀ ਜਾਂ ਅੰਗਰੇਜ਼ੀ ਵਿੱਚ ਮੱਧ ਪ੍ਰਦੇਸ਼ ਦੀ ਮਿੱਟੀ ਤਿਆਰ ਕਰਨ, ਸੋਇਆਬੀਨ/ਕਣਕ ਦੇ ਚੱਕਰ ਅਤੇ ਜੈਵਿਕ ਰੋਕਥਾਮ ਵਿੱਚ ਤੁਹਾਡੀ ਮਦਦ ਕਰ ਸਕਦਾ ਹਾਂ। ਅੱਜ ਮੈਂ ਤੁਹਾਡੀ ਕੀ ਮਦਦ ਕਰਾਂ?",
    settingsTitle: "API ਸੰਰਚਨਾ",
    settingsInstruction: "ਨਿਦਾਨ ਸਕੈਨਿੰਗ ਅਤੇ ਚੈਟ ਸੇਵਾਵਾਂ ਨੂੰ ਚਾਲੂ ਕਰਨ ਲਈ ਕਿਰਪਾ ਕਰਕੇ ਆਪਣੀ Google Gemini API ਕੁੰਜੀ ਦਰਜ ਕਰੋ। ਇਹ ਕੁੰਜੀ ਤੁਹਾਡੇ ਬ੍ਰਾਊਜ਼ਰ ਕੈਸ਼ ਵਿੱਚ ਸੁਰੱਖਿਅਤ ਰਹੇਗੀ।",
    apiKeyLabel: "Gemini API ਕੁੰਜੀ",
    saveSettingsBtn: "ਸੈਟਿੰਗਾਂ ਸੁਰੱਖਿਅਤ ਕਰੋ",
    toastKeySaved: "API ਕੁੰਜੀ ਸਫਲਤਾਪੂਰਵਕ ਸੁਰੱਖਿਅਤ ਕੀਤੀ ਗਈ!",
    toastKeyMissing: "ਕਿਰਪਾ ਕਰਕੇ ਪਹਿਲਾਂ ਸੈਟਿੰਗਾਂ ਵਿੱਚ Gemini API ਕੁੰਜੀ ਦਰਜ ਕਰੋ।",
    toastNoImage: "ਕਿਰਪਾ ਕਰਕੇ ਜਾਂਚ ਲਈ ਇੱਕ ਫ਼ਸਲ ਦੀ ਫੋਟੋ ਅਪਲੋਡ ਕਰੋ।",
    toastScanSuccess: "ਬਿਮਾਰੀ ਦਾ ਨਿਦਾਨ ਸਫਲਤਾਪੂਰਵਕ ਪੂਰਾ ਹੋਇਆ!",
    toastScanFailed: "ਫੋਟੋ ਦੀ ਜਾਂਚ ਕਰਨ ਵਿੱਚ ਅਸਫਲ। ਕਿਰਪਾ ਕਰਕੇ ਆਪਣੀ API ਕੁੰਜੀ ਅਤੇ ਇੰਟਰਨੈਟ ਦੀ ਜਾਂਚ ਕਰੋ।",
    ...
    toastSpeechInputNotSupported: "ਇਸ ਬ੍ਰਾਊਜ਼ਰ ਵਿੱਚ ਸਪੀਚ ਰਿਕੋਗਨੀਸ਼ਨ ਸਮਰਥਿਤ ਨਹੀਂ ਹੈ।",
    ...
    defaultAdvisories: {
      bhopal: "ਮਾਨਸੂਨ ਵਿੱਚ ਦੇਰੀ ਦੀ ਚੇਤਾਵਨੀ। ਸੋਇਆਬੀਨ ਅਤੇ ਮੱਕੀ ਦੀ ਬਿਜਾਈ ਉਦੋਂ ਤੱਕ ਮੁਲਤਵੀ ਕਰੋ ਜਦੋਂ ਤੱਕ 50-60 ਮਿਲੀਮੀਟਰ ਮੀਂਹ ਨਾ ਪੈ ਜਾਵੇ, ਤਾਂ ਜੋ ਬੀਜ ਖ਼ਰਾਬ ਹੋਣ ਤੋਂ ਬਚਿਆ ਜਾ ਸਕੇ।",
      indore: "ਮਾਲਵਾ ਵਿੱਚ ਖੁਸ਼ਕ ਹਾਲਤਾਂ। ਸੋਇਆਬੀਨ ਅਤੇ ਦਾਲਾਂ ਦੀ ਬਿਜਾਈ ਲਈ ਜ਼ਮੀਨ ਤਿਆਰ ਕਰੋ। ਜੈਵਿਕ ਖਾਦ ਪਾਓ ਅਤੇ ਨਮੀ ਦੀ ਨਿਗਰਾਨੀ ਕਰੋ।",
      jabalpur: "ਭਾਰੀ ਮੀਂਹ ਦਾ ਅਲਰਟ। ਝੋਨੇ ਦੀਆਂ ਨਰਸਰੀਆਂ ਵਿੱਚ ਪਾਣੀ ਦੇ ਨਿਕਾਸ ਦਾ ਉਚਿਤ ਪ੍ਰਬੰਧ ਕਰੋ। ਸੁੱਕੇ ਮੌਸਮ ਤੋਂ ਪਹਿਲਾਂ ਕੀਟਨਾਸ਼ਕਾਂ ਦੇ ਛਿੜਕਾਅ ਤੋਂ ਬਚੋ।"
    }
  }
};
...
const elements = {
  ...
  preventativeMeasuresTitle: document.getElementById('preventative-measures-title'),
...
function changeLanguage(lang) {
  ...
  if (state.speechSynthesisActive) {
    ...
    elements.speakBtnText.textContent = TRANSLATIONS[state.currentLanguage].speakBtnText;
  }
}
...
function updateUIStrings(lang) {
  ...
  if (!state.btnLoader.classList.contains('hidden')) {
...
function updateKeyStatusDisplay() {
  ...
  if (state.apiKey) {
    elements.keyStatus.textContent = state.currentLanguage === 'en' ? "✓ Key Saved" : (state.currentLanguage === 'hi' ? "✓ कुंजी सुरक्षित" : "✓ ਕੁੰਜੀ ਸੁਰੱਖਿਅਤ");
    elements.keyStatus.className = "key-status-indicator saved";
  } else {
    elements.keyStatus.textContent = state.currentLanguage === 'en' ? "✗ No key saved" : (state.currentLanguage === 'hi' ? "✗ कोई कुंजी नहीं सहेजी गई" : "✗ ਕੋਈ ਕੁੰਜੀ ਨਹੀਂ");
  ...
  advisoryTimeout = setTimeout(async () => {
    ...
    try {
      ...
      if (response && response.trim()) {
        elements.weatherAdvisoryText.textContent = response.trim();
      }
    } catch (e) {
      console.warn("Failed to generate dynamic AI weather advisory. Using fallback local templates.", e);
    }
  }, 1500);
}
...
function renderDiagnosisResults(data) {
  ...
  } else if (sev.includes('medium') || sev.includes('मध्यम') || sev.includes('ਦਰਮਿਆਨਾ')) {
  ...
  const organicStr = Array.isArray(data.organic) ? data.organic.join(', ') : data.organic;
  const chemicalStr = Array.isArray(data.chemical) ? data.chemical.join(', ') : data.chemical;
...
function toggleDiagnosisSpeech() {
  ...
  if (state.speechSynthesisActive) {
    ...
    elements.speakBtnText.textContent = state.currentLanguage === 'en' ? "Stop" : (state.currentLanguage === 'hi' ? "रोकें" : "ਰੋਕੋ");
    ...
    if (state.currentLanguage === 'hi') {
      ...
      selectedVoice = voices.find(v => v.lang.startsWith('pa')) || voices.find(v => v.lang.startsWith('hi')); 
    } else {
...
async function handleChatSubmit() {
  ...
  try {
    ...
    removeChatThinkingBubble(thinkingId);
    appendChatMessage("Apologies, I encountered an issue. Please verify your Gemini API Key in the settings panel.", 'system');
  }
}
